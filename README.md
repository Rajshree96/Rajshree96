...
- 🏗️ Building **scalable component systems** & **reusable UI libraries**
- ⚡ Improved app performance using **lazy loading, code splitting & memoization**
- 🔌 Strong experience in **REST API integration** using Axios
- 🎨 Pixel-accurate **Figma to responsive UI** conversions
- 🌱 Currently exploring **MERN Stack** (Node.js + Express + MongoDB)
...
- ⚡ Optimize performance using **code splitting, lazy loading & memoization**
- 🔐 Implement **auth-aware routing** with centralized route guards
- 🔌 Integrate **REST APIs** with Axios interceptors & custom hooks
- 🎨 Convert **Figma designs** into pixel-perfect, responsive UIs
- 🐛 Debug UI issues with **Chrome DevTools & React Profiler**
...
- Integrated **REST APIs** using Axios for auth, product listing & order management
- Improved performance using **lazy loading, code splitting & memoization**
...
- 🧪 **Testing Culture** — Integration tests with RTL, E2E with Playwright
- 🌿 **MERN Stack** — Expanding full-stack capabilities
- 🎯 **Senior Frontend Role** @ Product-Based / US Company
...
If you find my repositories useful or interesting — ⭐ **star them!** It means a lot 🙏
...
<p align="center">
  <i>"Great UI is not just what it looks like — it's how well it scales, performs, and stays maintainable."</i>
</p>
